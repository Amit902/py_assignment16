...
db=py.connect("localhost","root","amit9729231169","library")
cursor=db.cursor()
cursor.execute("insert into book values(001,'searching for mountain','nepal','himalayan')")
cursor.execute("insert into titles values(002,'looking for hill','1005',201,2005)")
cursor.execute("insert into publishers values(203214,'nepoleon','nepal',201,2010)")
cursor.execute("insert into zip_codes values(20465,'kathmandu',5042135)")
